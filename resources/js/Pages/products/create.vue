<template>
    <div class="flex justify-center items-center h-screen bg-gradient">
      <div class="flex max-w-2xl mx-auto p-8 bg-gradient-to-br from-red-300 to-red-500 rounded-lg shadow-3d transform hover:scale-105 transition duration-300 relative">
        <div class="w-full">
          ...
          <form @submit.prevent="submit">
            <div class="mb-4">
              ...
              <input type="text" id="name" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-red-500 input-shadow" v-model="form.name">
            </div>
            <div class="mb-4">
              <label for="description" class="block text-white font-bold mb-2 label-shadow">Description</label>
              <input type="text" id="description" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-red-500 input-shadow" v-model="form.description">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
              ...
              <input type="number" id="price" class="w-full px-3 py-2 border rounded-md focus:outline-none focus:border-red-500 input-shadow" v-model="form.price">
            </div>
            <div class="flex">
              <button type="submit" class="w-full bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 focus:outline-none focus:bg-red-700 button-shadow">Save Product</button>
  ...
  .bg-gradient-to-br {
    background-image: linear-gradient(to bottom right, #f0baa7, #ff6347);
  }
